package com.tunion.chain.bitcoinj.controller;
...
public class BitcoinController {
    private static Logger logger = LoggerFactory.getLogger(BitcoinController.class);
    ...
    public Results createAddress(HttpServletRequest request)
    {
        ...
        try{
            ...
            results = bitcoinService.createAddress(JavaReflectUtil.obj2str(searchParams.get("accountName")));
    ...
    public Results withdrawalCash(HttpServletRequest request)
    {
        ...
        try{
            ...
            results = bitcoinService.withdrawalCash(JavaReflectUtil.obj2str(searchParams.get("accountName")),JavaReflectUtil.obj2str(searchParams.get("accountAddress")),
    ...
    public Results getBalance(HttpServletRequest request)
    {
        ...
        try{
            ...
            results = bitcoinService.getBalance(JavaReflectUtil.obj2str(searchParams.get("accountName")));
